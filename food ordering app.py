class Restaurant:
    ...
    def _init_(self, name):                       # ID, Food Name,  Quantity,  Discount,   Price,   Stock
        self.name=name
        ...
        self.user_details={1: {"User Name" : "prashant", "Phone No." : 7780536616, "Email_ID" : 'prashantbhandari141@gmail.com', 'Password' : 'FREE FOOD', 'Address' : "Hyderabad"},
                           2: {"User Name" : "Ballu", "Phone No." : 1234567890, "Email_ID" : 'pratyush@dummy.com', 'Password' : 'FREE FOOD', 'Address' : "Hyderabad"}}
        self.admin_details={1: {"Admin Name" : "Tillu", "Phone No." : 7780536616, "Email_ID" : 'tarun@dummy.com', 'Password' : 'FREE FOOD', 'Address' : "Hyderabad"}}
